...
- 当前正在学习 Java Web 和 Spring，后续学习 Spring MVC、MyBatis、Spring Boot。
...
- `spring-training`：已完成原生 Servlet、Filter、Listener、Session、JDBC、事务、WAR 构建和部署，以及 Spring Core 的 XML/注解双轮 IoC、DI、生命周期、AOP、事务、后置处理器和自调用代理边界练习。
